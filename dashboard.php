...
<section class="section">
    <div class="container">
        ...
        <div class="card text-center">
            <h2>Bienvenue 👋</h2>
            <p class="mt-20">Gère ton argent intelligemment</p>
        </div>
        ...
        <div class="grid mt-20">
            ...
            <div class="card text-center">
                <h3>💰 Solde</h3>
                <h2 class="balance-amount"><?= $solde ?> TND</h2>
            </div>
            ...
            <div class="card">
                ...
                <?php if($objectif): ?>
                    ...
                    <p class="text-center"><?= round($progress) ?>%</p>
                <?php else: ?>
                    <p>Aucun objectif</p>
                <?php endif; ?>
            </div>
        ...
        <div class="card mt-20">
            ...
            <ul class="list">
                <?php while($t = $transactions->fetch_assoc()): ?>
                    <li>
                        <strong><?= $t['type'] == 'depense' ? '-' : '+' ?> <?= $t['montant'] ?> TND</strong><br>
